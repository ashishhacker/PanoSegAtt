...
def train(opt):
    ...
    while True:
        ...
        if data['bounds']['wrapped']:
            ...
            # val_loss, predictions, lang_stats, cocoEval = eval_utils.eval_split(dp_model, crit, loader, eval_kwargs)
            val_loss, predictions, lang_stats, cocoEval = eval_utils.eval_split(model, crit, loader, eval_kwargs)
